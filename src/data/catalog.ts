...
export const baseProducts: Product[] = [
  ...
  },
  {
    ...
    sku: 'PBH-TMP-09',
    description:
      'Arched wood-grain mandir with a dark grid centrepiece and gold ginkgo accents — calm, modern prayer niche styling.',
    style: ['modern', 'warm', 'minimal'],
    rooms: ['puja', 'temple', 'living room'],
    ...
    highlights: [
      'Arched niche silhouette',
      'Natural wood grain finish',
      'Gold ginkgo accents',
      'Dark grid door detail',
      'Customise size & finish',
      'WhatsApp quote available',
    ],
  },
