...
export const baseProducts: Product[] = [
  ...
  },
  {
    ...
    sku: 'PBH-TMP-07',
    description:
      'Modern grey shutter mandir with arched lattice windows, vine fretwork corners, and a warm-lit marble altar interior.',
    style: ['modern', 'minimal', 'luxe'],
    rooms: ['puja', 'temple'],
    ...
    highlights: [
      'Arched lattice shutters',
      'Marble-look altar interior',
      'Warm cove lighting',
      'Full-height niche design',
      'Customise size & finish',
      'WhatsApp quote available',
    ],
  },
