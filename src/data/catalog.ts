...
export const baseProducts: Product[] = [
  ...
  },
  {
    ...
    sku: 'PBH-TMP-13',
    description:
      'Ivory temple doors with stacked sunburst jali panels and scroll relief — a glowing, geometric façade for modern puja niches.',
    ...
    highlights: [
      ...
      'Scroll relief accents',
      'Ivory matte PU finish',
      'Warm lit puja interior',
      'Customise size & finish',
      'WhatsApp quote available',
    ],
  },
