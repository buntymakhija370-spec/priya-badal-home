...
export const categories: Category[] = [
  {
    ...
    name: 'Leena',
    description:
      'Leather shutters for wardrobes and closets — padded leather-look façades with tailored stitch, made to your opening.',
    caption: 'Leather Shutters · High demand',
    conceptNote:
      'Leena is our dedicated leather shutter line. Soft leather-look façades with neat top-stitch, measured to your wardrobe or closet opening. Confirm leather tone, stitch layout, and handle style on WhatsApp. Rates are per sq ft for the shutter face.',
    image: '/products/categories/leather-shutters.jpg',
    video: '/products/categories/silaibunai.mp4',
    subcategories: [
      {
        id: 'leather',
        name: 'Leather Shutters',
        description:
          'Padded leather-look wardrobe and closet shutters — Linear, Urban, Modu, Nawabee, Zardosi, Wave, and Aura.',
      },
    ],
  },
  {
...
export const baseProducts: Product[] = [
...

  {
    ...
    description:
      'Floor-to-ceiling powder-blue feature wall with geometric cutouts lined in natural rattan cane webbing — 14 mm engineered wood · ₹2,200 / sq ft. Made to measure; confirm size on WhatsApp.',
    ...
    highlights: [
      '14 mm',
      'Rattan cane + engineered wood',
      '₹2,200 / sq ft',
      'Geometric cane cutouts',
      'Made to measure',
      'WhatsApp quote available',
    ],
    details: [
      ...
      { label: 'Primary Material', value: 'Rattan cane + engineered wood' },
      { label: 'Assembly', value: 'Carpenter Assembly (on-site)' },
      { label: 'Dimensions', value: 'Made to measure (custom width × height)' },
    ...
    specifications: [
      ...
      { label: 'Material', value: 'Rattan cane + engineered wood' },
      { label: 'Colour / Finish', value: 'Powder blue · rattan cane inlays' },
      { label: 'Inlay', value: 'Natural cane / rattan webbing' },
      { label: 'Board Thickness', value: '14 mm' },
      { label: 'Pricing', value: '₹2,200 / sq ft' },
...

  {
    ...
    description:
      'Architectural wall cladding with vertical fluted slats and soft arched insets — 6 mm · ceramic finish · ₹1,000 / sq ft. Made to measure; confirm size on WhatsApp.',
    ...
    specifications: [
      ...
      { label: 'Pricing', value: '₹1,000 / sq ft' },
      { label: 'Category', value: 'Wall Panels' },
...

  {
    ...
    defaultThicknessId: '12',
    finishOptionIds: ['oxidised-base'],
    thicknessOptionIds: ['12'],
    brand: 'Priyabadal Homes',
    collection: 'Wall Panels',
    sku: 'PBH-WP-DIA-CANE-01',
    description:
      'Stone-effect feature wall with recessed diamond rattan cane inlays — 12 mm · oxidisation finish · ₹1,800 / sq ft. Made to measure; confirm size on WhatsApp.',
    ...
    details: [
      ...
      { label: 'Finish', value: 'Oxidisation' },
      { label: 'Assembly', value: 'Carpenter Assembly (on-site)' },
      { label: 'Dimensions', value: 'Made to measure (custom width × height)' },
    ...
    specifications: [
      { label: 'Type', value: 'Decorative feature wall panel' },
      { label: 'Colour / Finish', value: 'Oxidisation' },
      { label: 'Inlay', value: 'Rattan cane' },
      { label: 'Accents', value: 'Slim metal trim (gold / silver tone options)' },
      { label: 'Board Thickness', value: '12 mm' },
      { label: 'Pricing', value: '₹1,800 / sq ft' },
      { label: 'Category', value: 'Wall Panels' },
...

  {
    ...
    sku: 'PBH-WP-G08',
    description:
      'Staggered rose-gold vertical rain strips over a matte grey field — reception and lobby drama. 6 mm engineered wood · polyurethane coating · ₹1,000 / sq ft. Standard panel 2440 × 1220 mm (8 × 4 ft); colour customisable.',
    style: ['modern', 'feature', 'luxe'],
    rooms: ['living room', 'bedroom', 'hallway', 'office', 'retail', 'wall panels'],
    ...
    specifications: [
      { label: 'Panel rate', value: '₹1,000 / sq ft' },
      { label: 'Base material', value: 'Engineered wood' },
      { label: 'Colour / Finish', value: 'Polyurethane coating · custom colour' },
      { label: 'Board Thickness', value: '6 mm' },
      { label: 'Panel size', value: '2440 × 1220 mm (8 × 4 ft)' },
    ...
    orderNotes: [
      'Panel: 6 mm engineered wood · PU coating · ₹1,000 / sq ft',
      'Standard sheet 2440 × 1220 mm (8 × 4 ft) · colour customisable',
...

  {
    ...
    sku: 'PBH-WP-G09',
    description:
      'Wide vertical boards with slim metallic channel dividers — clean studio and prayer-room façades. 6 mm engineered wood · polyurethane coating · ₹800 / sq ft. Standard panel 2440 × 1220 mm (8 × 4 ft); colour customisable.',
    style: ['modern', 'feature', 'luxe'],
    rooms: ['living room', 'bedroom', 'hallway', 'office', 'retail', 'wall panels'],
    ...
    specifications: [
      { label: 'Panel rate', value: '₹800 / sq ft' },
      { label: 'Base material', value: 'Engineered wood' },
      { label: 'Colour / Finish', value: 'Polyurethane coating · custom colour' },
      { label: 'Board Thickness', value: '6 mm' },
      { label: 'Panel size', value: '2440 × 1220 mm (8 × 4 ft)' },
    ...
    orderNotes: [
      'Panel: 6 mm engineered wood · PU coating · ₹800 / sq ft',
      'Standard sheet 2440 × 1220 mm (8 × 4 ft) · colour customisable',
...

  {
    ...
    sku: 'PBH-WP-G13',
    description:
      'Asymmetric facets with gold inlays and stippled fields — luxe bedroom headboard walls. 6 mm engineered wood · polyurethane coating · ₹700 / sq ft. Standard panel 2440 × 1220 mm (8 × 4 ft); colour customisable.',
    style: ['modern', 'feature', 'luxe'],
    rooms: ['living room', 'bedroom', 'hallway', 'office', 'retail', 'wall panels'],
    ...
    specifications: [
      { label: 'Panel rate', value: '₹700 / sq ft' },
      { label: 'Base material', value: 'Engineered wood' },
      { label: 'Colour / Finish', value: 'Polyurethane coating · custom colour' },
      { label: 'Board Thickness', value: '6 mm' },
      { label: 'Panel size', value: '2440 × 1220 mm (8 × 4 ft)' },
    ...
    orderNotes: [
      'Panel: 6 mm engineered wood · PU coating · ₹700 / sq ft',
      'Standard sheet 2440 × 1220 mm (8 × 4 ft) · colour customisable',
...

  {
    ...
    sku: 'PBH-WP-G16',
    description:
      'Cream fluted field with staggered metallic gold inserts — boutique reception feature wall. 6 mm engineered wood · polyurethane coating · ₹900 / sq ft. Standard panel 2440 × 1220 mm (8 × 4 ft); colour customisable.',
    style: ['modern', 'feature', 'luxe'],
    rooms: ['living room', 'bedroom', 'hallway', 'office', 'retail', 'wall panels'],
    ...
    specifications: [
      { label: 'Panel rate', value: '₹900 / sq ft' },
      { label: 'Base material', value: 'Engineered wood' },
      { label: 'Colour / Finish', value: 'Polyurethane coating · custom colour' },
      { label: 'Board Thickness', value: '6 mm' },
      { label: 'Panel size', value: '2440 × 1220 mm (8 × 4 ft)' },
    ...
    orderNotes: [
      'Panel: 6 mm engineered wood · PU coating · ₹900 / sq ft',
      'Standard sheet 2440 × 1220 mm (8 × 4 ft) · colour customisable',
...

  {
    ...
    sku: 'PBH-WP-G17',
    description:
      'Scattered three-diamond motifs in relief and metallic inlay — showroom and boutique façades. 6 mm engineered wood · polyurethane coating · ₹800 / sq ft. Standard panel 2440 × 1220 mm (8 × 4 ft); colour customisable.',
    style: ['modern', 'feature', 'luxe'],
    rooms: ['living room', 'bedroom', 'hallway', 'office', 'retail', 'wall panels'],
...

  {
    ...
    specifications: [
      ...
      { label: 'Pricing', value: '₹2,600 / sq ft · handle ₹5,500 (single piece)' },
...

  {
    ...
    specifications: [
      ...
      { label: 'Colour / Finish', value: 'Both-side PU finish' },
      { label: 'Board Thickness', value: '25 mm' },
      {
        label: 'Handles',
    ...
    orderNotes: [
      '25 mm · Both-side PU finish · ₹2,600 / sq ft',
      'Handle-less'
    ],
    features: [
...

  {
    ...
    specifications: [
      ...
      { label: 'Colour / Finish', value: 'Both-side PU coating' },
      { label: 'Board Thickness', value: '25 mm' },
      {
        label: 'CNC-Carve HD Board',
        value: '25 mm · ₹1,600 / sq ft · no paint / no finishing (white canvas)',
      },
      { label: 'Pricing', value: '₹5,000 / sq ft' },
      { label: 'Category', value: 'Temple' },
      { label: 'Subcategory', value: 'Carved' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Wipe with a soft dry cloth; avoid harsh cleaners' },
    ...
    orderNotes: [
      '25 mm · Both-side PU coating · ₹5,000 / sq ft'
    ],
    features: [
...

  {
    ...
    orderNotes: [
      '22 mm · Both-side laminated · ₹1,600 / sq ft'
    ],
    features: [
      'Temple doors only — carcass not included',
...

  {
    ...
    specifications: [
      ...
      { label: 'Colour / Finish', value: 'Both-side ceramic coating' },
      { label: 'Board Thickness', value: '25 mm' },
      {
        label: 'Handles',
        value: 'No handles — handle-less shutters (no future handle maintenance)',
...

  {
    ...
    orderNotes: [
      '25 mm · Ceramic coating · ₹1,500 / sq ft'
    ],
    disclaimer:
      'Accessories and room settings in images are for representation only. Final colour, finish, size, and carcass scope are confirmed on WhatsApp before production.',
  },
...

  {
    ...
    sku: 'PBH-HDL-01',
    description:
      'Sculpted pink lotus handle for shutters and temple doors. Sold as a single piece. Confirm finish and fitting on WhatsApp.',
...

  {
    ...
    pricingMode: 'per-sqft',
    defaultFinishId: 'veneer-pu-half',
    defaultThicknessId: '48',
    finishOptionIds: ['veneer-pu-half'],
    thicknessOptionIds: ['48'],
    brand: 'Priyabadal Homes',
...

  {
    ...
    currency: 'INR',
    pricingMode: 'per-sqft',
    defaultFinishId: 'veneer-acrylic',
    defaultThicknessId: '48',
    finishOptionIds: ['veneer-acrylic'],
    thicknessOptionIds: ['48'],
    brand: 'Priyabadal Homes',
    collection: 'Designer Doors',
    sku: 'PBH-DR-02',
    tags: ['Brass strip on it'],
    description:
...

  {
    ...
    collection: 'Designer Doors',
    sku: 'PBH-DR-03',
    tags: ['Single sheet CNC made door'],
    description:
    ...
    highlights: [
      ...
      'Tiered crown casing',
      '₹5,000 / sq ft',
      'Ceramic · both sides same design · 55 mm',
      'Single sheet CNC made door',
...

  {
    ...
    pricingMode: 'per-sqft',
    defaultFinishId: 'pu',
    defaultThicknessId: '51',
    finishOptionIds: ['pu'],
    thicknessOptionIds: ['51'],
    brand: 'Priyabadal Homes',
    collection: 'Designer Doors',
    sku: 'PBH-DR-06',
    description:
...

  {
    ...
    pricingMode: 'per-sqft',
    defaultFinishId: 'pu-metallic-both',
    defaultThicknessId: '47',
    finishOptionIds: ['pu-metallic-both'],
    thicknessOptionIds: ['47'],
    brand: 'Priyabadal Homes',
    collection: 'Designer Doors',
    sku: 'PBH-DR-07',
    description:
...

  {
    ...
    pricingMode: 'per-sqft',
    defaultFinishId: 'ceramic-both',
    defaultThicknessId: '60',
    finishOptionIds: ['ceramic-both'],
    thicknessOptionIds: ['60'],
    brand: 'Priyabadal Homes',
    collection: 'Designer Doors',
    sku: 'PBH-DR-09',
    tags: ['Inside structure, aluminium'],
    description:
    ...
    highlights: [
      ...
      '₹4,800 / sq ft',
      'Ceramic · both sides same design · 60 mm',
      'Inside structure, aluminium',
      'Both sides same design',
      'Made to measure',
    ],
  },
...

  {
    ...
    currency: 'INR',
    pricingMode: 'per-sqft',
    defaultFinishId: 'bronze-oxidised',
    defaultThicknessId: '60',
    finishOptionIds: ['bronze-oxidised'],
    thicknessOptionIds: ['60'],
    brand: 'Priyabadal Homes',
    collection: 'Designer Doors',
    sku: 'PBH-DR-11',
...

  {
    ...
    currency: 'INR',
    pricingMode: 'per-sqft',
    defaultFinishId: 'brass-oxidised',
    defaultThicknessId: '47',
    finishOptionIds: ['brass-oxidised'],
    thicknessOptionIds: ['47'],
    brand: 'Priyabadal Homes',
    collection: 'Designer Doors',
    sku: 'PBH-DR-12',
...

  {
    ...
    details: [{ label: 'Primary Material', value: 'FRP' }],
    specifications: [
      { label: 'Material', value: 'FRP' },
      { label: 'Price', value: '₹92,000 (pair)' },
    ],
  },

  {
    ...
    sku: 'PBH-SF-02',
    description:
      'Clear toughened glass dining top on a sculpted driftwood / organic trunk base in silver-champagne finish — art dining centrepiece. Set includes sculpted leg, 4′×4′ toughened glass top, and 4 chairs. Confirm seating size on WhatsApp.',
    ...
    highlights: [
      'Sculpted dining leg ₹42,000',
      'Toughened 12 mm glass top 4′×4′ ₹8,000',
      '4 chairs × ₹15,000 = ₹60,000',
      'Set total ₹1,10,000',
      'Silver-champagne finish',
      'WhatsApp for exact size',
    ],
    specifications: [
      { label: 'Sculpted dining leg', value: '₹42,000' },
      { label: 'Glass top', value: 'Toughened 12 mm · 4′×4′ · ₹8,000' },
      { label: 'Chairs', value: '4 × ₹15,000 = ₹60,000' },
      { label: 'Set total', value: '₹1,10,000' },
    ],
  },
...

  {
    ...
    sku: 'PBH-SF-04',
    description:
      'Rectangular toughened glass dining table on twin sculpted rock pedestals — dark earth and sand-grey stone forms. Set includes 2-leg sculpted base, 6′×3′ toughened glass top, and 4 chairs. Confirm seating count on WhatsApp.',
    ...
    highlights: [
      'Sculpted dining 2-leg set ₹64,000',
      'Toughened 12 mm glass top 6′×3′ ₹9,000',
      '4 chairs × ₹15,000 = ₹60,000',
      'Set total ₹1,33,000',
    ...
    specifications: [
      { label: 'Sculpted dining 2-leg set', value: '₹64,000' },
      { label: 'Glass top', value: 'Toughened 12 mm · 6′×3′ · ₹9,000' },
      { label: 'Chairs', value: '4 × ₹15,000 = ₹60,000' },
      { label: 'Set total', value: '₹1,33,000' },
    ],
  },
...

  {
    ...
    sku: 'PBH-SF-11',
    description:
      'Asymmetric FRP boulder-base console pair with optional stone or wood top. Entry or living statement piece; confirm top choice, finish, and length on WhatsApp.',
    ...
    tags: ['FRP'],
    highlights: [
      'FRP base pair ₹68,000',
      'Stone top ₹40,000',
      'Wood top ₹35,000',
      'With stone top ₹1,08,000 · with wood top ₹1,03,000',
      'WhatsApp for finish & length',
    ],
    details: [{ label: 'Primary Material', value: 'FRP (base)' }],
    specifications: [
      { label: 'Base material', value: 'FRP' },
      { label: 'Base pair', value: '₹68,000' },
      { label: 'Stone top', value: '₹40,000' },
      { label: 'Wood top', value: '₹35,000' },
      { label: 'With stone top', value: '₹1,08,000' },
      { label: 'With wood top', value: '₹1,03,000' },
    ],
  },

  {
    ...
    sku: 'PBH-SF-12',
    description:
      'Serene sculpted FRP face base with organic wavy 8 mm toughened glass top — golden brass or light stone finish. Price includes glass. Living-room art coffee table; confirm finish and size on WhatsApp.',
    ...
    tags: ['FRP'],
    highlights: [
      'FRP sculpted face base',
      '8 mm toughened glass top',
      'Price with glass ₹48,000',
    ...
    specifications: [
      { label: 'Base material', value: 'FRP' },
      { label: 'Top material', value: '8 mm toughened glass' },
      { label: 'Price with glass', value: '₹48,000' },
    ],
  },
...

  {
    ...
    currency: 'INR',
    pricingMode: 'per-sqft',
    defaultFinishId: 'leather-oxidised',
    defaultThicknessId: '12',
    finishOptionIds: ['leather-oxidised'],
    thicknessOptionIds: ['12'],
    brand: 'Priyabadal Homes',
    ...
    highlights: [
      '12 mm',
      'Finish · Leather & oxidisation',
      'Material · Leather with oxidisation',
      '₹5,000 / sq ft',
      'Made to measure',
      'WhatsApp quote',
    ],
    details: [
      ...
      { label: 'Thickness', value: '12 mm' },
      { label: 'Finish', value: 'Leather & oxidisation' },
      { label: 'Primary Material', value: 'Leather with oxidisation' },
      { label: 'Service', value: 'Custom upholstery / soft furnishing stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      { label: 'Type', value: 'Silai Bunai / wall panel' },
      { label: 'Material', value: 'Leather with oxidisation' },
      { label: 'Finish', value: 'Leather & oxidisation' },
      { label: 'Thickness', value: '12 mm' },
...

  {
    ...
    currency: 'INR',
    pricingMode: 'per-sqft',
    defaultFinishId: 'leather',
    defaultThicknessId: '8',
    finishOptionIds: ['leather'],
    thicknessOptionIds: ['8'],
    brand: 'Priyabadal Homes',
    collection: 'Silai Bunai',
    sku: 'PBH-SILAI-02',
    ...
    highlights: [
      '8 mm',
      'Finish · Leather',
      'Material · Bio leather & engineered wood',
      '₹1,600 / sq ft',
      'Made to measure',
      'WhatsApp quote',
    ],
    details: [
      ...
      { label: 'Finish', value: 'Leather' },
      { label: 'Primary Material', value: 'Bio leather & engineered wood' },
      { label: 'Service', value: 'Custom upholstery / soft furnishing stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      { label: 'Type', value: 'Silai Bunai / wall panel' },
      { label: 'Material', value: 'Bio leather & engineered wood' },
      { label: 'Finish', value: 'Leather' },
      { label: 'Thickness', value: '8 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹1,600 / sq ft' },
...

  {
    ...
    pricingMode: 'per-sqft',
    defaultFinishId: 'leather',
    defaultThicknessId: '4',
    finishOptionIds: ['leather'],
    thicknessOptionIds: ['4'],
    brand: 'Priyabadal Homes',
    collection: 'Silai Bunai',
    sku: 'PBH-SILAI-03',
    description:
    ...
    specifications: [
      ...
      { label: 'Thickness', value: '4 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹1,100 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
...

  {
    ...
    details: [
      ...
      { label: 'Thickness', value: '8 mm' },
      { label: 'Finish', value: 'Leather' },
      { label: 'Primary Material', value: 'Leather finish panel' },
      { label: 'Service', value: 'Custom upholstery / soft furnishing stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      { label: 'Type', value: 'Silai Bunai / wall panel' },
      { label: 'Material', value: 'Leather finish panel' },
      { label: 'Finish', value: 'Leather' },
      { label: 'Thickness', value: '8 mm' },
      { label: 'Category', value: 'Silai Bunai' },
...

  {
    ...
    currency: 'INR',
    pricingMode: 'per-sqft',
    defaultFinishId: 'denim',
    defaultThicknessId: '8',
    finishOptionIds: ['denim'],
    thicknessOptionIds: ['8'],
    brand: 'Priyabadal Homes',
    collection: 'Silai Bunai',
    sku: 'PBH-SILAI-05',
    ...
    details: [
      ...
      { label: 'Thickness', value: '8 mm' },
      { label: 'Finish', value: 'Denim' },
      { label: 'Primary Material', value: 'Denim' },
      { label: 'Service', value: 'Custom upholstery / soft furnishing stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      ...
      { label: 'Thickness', value: '8 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹1,700 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
...

  {
    ...
    details: [
      ...
      { label: 'Thickness', value: '6 mm' },
      { label: 'Finish', value: 'Leather' },
      { label: 'Primary Material', value: 'Leather' },
      { label: 'Service', value: 'Custom upholstery / soft furnishing stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      ...
      { label: 'Thickness', value: '6 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹2,100 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
...

  {
    ...
    specifications: [
      ...
      { label: 'Thickness', value: '12 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹2,900 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
...

  {
    ...
    specifications: [
      ...
      { label: 'Thickness', value: '6 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹1,300 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
...

  {
    ...
    highlights: [
      '25 mm',
      'Finish · Denim · both sides',
      'Material · BWP plywood',
      '₹3,500 / sq ft',
      'Wardrobe shutter',
      'Hand embroidery design as shown',
      'Back also same denim',
      'Base · BWP plywood',
      'Made to measure',
      'WhatsApp quote',
    ],
    details: [
      ...
      { label: 'Finish', value: 'Denim · both sides' },
      { label: 'Primary Material', value: 'BWP plywood' },
      { label: 'Service', value: 'Custom upholstery / soft furnishing stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      { label: 'Type', value: 'Wardrobe shutter silai bunai' },
      { label: 'Material', value: 'BWP plywood' },
      { label: 'Finish', value: 'Denim · both sides' },
      { label: 'Thickness', value: '25 mm' },
      { label: 'Back', value: 'Same denim both sides' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹3,500 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
...

  {
    ...
    highlights: [
      '25 mm',
      'Finish · Leather · both sides',
      'Material · BWP plywood',
      '₹3,000 / sq ft',
      'Wardrobe shutter',
      'Back also same leather',
      'Base · BWP plywood',
      'Made to measure',
      'WhatsApp quote',
    ],
    details: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Finish', value: 'Leather · both sides' },
      { label: 'Primary Material', value: 'BWP plywood' },
      { label: 'Service', value: 'Custom upholstery / soft furnishing stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      ...
      { label: 'Finish', value: 'Leather · both sides' },
      { label: 'Thickness', value: '25 mm' },
      { label: 'Back', value: 'Same leather both sides' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹3,000 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
...

  {
    ...
    pricingMode: 'per-sqft',
    defaultFinishId: 'leather',
    defaultThicknessId: '16',
    finishOptionIds: ['leather'],
    thicknessOptionIds: ['16'],
    brand: 'Priyabadal Homes',
    collection: 'Silai Bunai',
    sku: 'PBH-SILAI-24',
    description:
...

  {
    ...
    highlights: [
      '25 mm',
      'Finish · Denim upholstery',
      'Material · BWP plywood',
      '₹2,500 / sq ft',
      'Wardrobe shutter · matches wardrobe catalog price',
      'Shutter ₹2,500 / sq ft',
      'Made to measure',
      'WhatsApp quote',
    ],
    details: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Finish', value: 'Denim upholstery' },
      { label: 'Primary Material', value: 'BWP plywood' },
    ...
    specifications: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹2,500 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
...

  {
    ...
    highlights: [
      '25 mm',
      'Finish · Olive upholstery · wave embroidery',
      'Material · BWP plywood',
      '₹3,500 / sq ft',
      'Wardrobe shutter · matches wardrobe catalog price',
      'Shutter ₹3,500 / sq ft',
    ...
    details: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Finish', value: 'Olive upholstery · wave embroidery' },
      { label: 'Primary Material', value: 'BWP plywood' },
...

  {
    ...
    highlights: [
      '25 mm',
      'Finish · Taupe upholstery · gold filigree',
      'Material · BWP plywood',
      '₹4,000 / sq ft',
      'Wardrobe shutter · matches wardrobe catalog price',
      'Shutter ₹4,000 / sq ft',
    ...
    details: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Finish', value: 'Taupe upholstery · gold filigree' },
      { label: 'Primary Material', value: 'BWP plywood' },
      { label: 'Service', value: 'Wardrobe shutter embroidery / stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹4,000 / sq ft' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
  ...
  {
    id: 'leena-linear-leather-shutters',
    name: 'Linear Leather Shutters',
    ...
    sku: 'PBH-SILAI-16',
    description:
      'Cream shaker wardrobe doors with neat panel top-stitch and matte black bar handles. Leena leather shutter — padded leather-look façade with tailored stitch. Confirm tone and stitch on WhatsApp.',
    style: ['custom', 'soft', 'homely'],
    rooms: ['living room', 'bedroom', 'lounge'],
    image: '/products/silaibunai/silai-16/01.jpg',
    images: [
    ...
    details: [
      { label: 'Brand', value: 'Leena' },
      { label: 'Collection', value: 'Leather Shutters' },
      { label: 'Sku', value: 'PBH-SILAI-16' },
      { label: 'Service', value: 'Custom upholstery / soft furnishing stitch' },
      { label: 'Warranty', value: "Workmanship warranty confirmed on order" },
    ],
    specifications: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹3,000 / sq ft · confirm size on WhatsApp' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
  ...
  {
    id: 'leena-urban-leather-shutters',
    name: 'Urban Leather Shutters',
    categoryId: 'leather-shutters',
    subcategoryId: 'leather',
    price: 3000,
    currency: 'INR',
    ...
    sku: 'PBH-SILAI-20',
    description:
      'Tan padded square-grid wardrobe shutters with inset stitch and wrapped pulls. Leena leather shutter — measured to your wardrobe opening.',
    style: ['custom', 'soft', 'homely'],
    rooms: ['living room', 'bedroom', 'lounge'],
    image: '/products/silaibunai/silai-20/01.jpg',
    images: [
  ...
  {
    id: 'leena-modu-leather-shutter',
    name: 'Modu Leather Shutter',
    categoryId: 'leather-shutters',
    subcategoryId: 'leather',
    price: 3000,
    currency: 'INR',
    ...
    sku: 'PBH-SILAI-23',
    description:
      'Off-white leather-look closet doors with double-edge and inset rectangle top-stitch. Leena leather shutter — tailored leather-look closet doors.',
    style: ['custom', 'soft', 'homely'],
    rooms: ['living room', 'bedroom', 'lounge'],
    image: '/products/silaibunai/silai-23/05.jpg',
    images: [
    ...
    imageCaptions: [
      'Product look — open wardrobe view.',
      'Full wardrobe look — leather shutters as shown.',
      'Edge detail — leather wrap and double stitch.',
    ],
    highlights: [
      '₹3,000 / sq ft',
      '25 mm',
  ...
  {
    id: 'leena-nawabee-leather-shutters',
    name: 'Nawabee Leather Shutters',
    categoryId: 'leather-shutters',
    subcategoryId: 'leather',
    price: 8000,
    currency: 'INR',
    ...
    sku: 'PBH-SILAI-27',
    description:
      'Olive upholstered wardrobe shutters with white wave embroidery and bead accents. Leena leather shutter for dressing-room wardrobes — confirm leather tone and motif on WhatsApp.',
    style: ['custom', 'artisan', 'luxe'],
    rooms: ['bedroom', 'dressing room'],
    image: '/products/silaibunai/silai-27/01.jpg',
    images: [
    ...
    specifications: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹8,000 / sq ft · confirm size on WhatsApp' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
  ...
  {
    id: 'leena-zardosi-leather-shutters',
    name: 'Zardosi Leather Shutters',
    categoryId: 'leather-shutters',
    subcategoryId: 'leather',
    price: 7000,
    currency: 'INR',
    ...
    sku: 'PBH-SILAI-28',
    description:
      'Taupe upholstered wardrobe shutters with gold filigree floral embroidery. Leena leather shutter for bedroom wardrobes — confirm leather tone and motif on WhatsApp.',
    style: ['custom', 'classic', 'luxe'],
    rooms: ['bedroom', 'dressing room'],
    image: '/products/silaibunai/silai-28/01.jpg',
    images: [
    ...
    specifications: [
      ...
      { label: 'Thickness', value: '25 mm' },
      { label: 'Category', value: 'Silai Bunai' },
      { label: 'Pricing', value: '₹7,000 / sq ft · confirm size on WhatsApp' },
      { label: 'Country of Origin', value: 'India' },
      { label: 'Care', value: 'Vacuum soft brush; spot clean as per fabric' },
    ],
    features: [
  ...
  {
    id: 'wave-leather-shutters-leena',
    name: 'Wave Leather Shutters',
    categoryId: 'leather-shutters',
    subcategoryId: 'leather',
    price: 3500,
    /**
    ...
    images: [
      '/products/silaibunai/silai-29/01.jpg',
      '/products/silaibunai/silai-29/02.jpg',
      '/products/silaibunai/silai-29/03.jpg',
      '/products/silaibunai/silai-29/04.jpg',
    ],
    imageCaptions: [
      'Full wardrobe look — wave stitch shutters.',
      'Open look — stitch and recessed pulls.',
      'Detail — wave double stitch on leather.',
    ...
    specifications: [
      { label: 'Type', value: 'Leather shutter / wardrobe façade' },
      { label: 'Base', value: 'Calibrated plywood' },
      { label: 'Thickness', value: '25 mm' },
...

  {
    ...
    images: [
      '/products/silaibunai/silai-30/01.jpg',
      '/products/silaibunai/silai-30/02.jpg',
      '/products/silaibunai/silai-30/03.jpg',
      '/products/silaibunai/silai-30/04.jpg',
    ],
    imageCaptions: [
      'Full wardrobe look — aura pattern shutters.',
      'Open wardrobe — pattern with lit interior.',
      'Lifestyle look — pattern across the run.',
