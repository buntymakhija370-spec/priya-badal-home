  ...
  },
{
  ...
  },
  {
    ...
    style: ['modern', 'minimal', 'luxe'],
    rooms: ['kitchen'],
    image: '/products/kitchen/lattice-grey/01.png',
    images: [
      '/products/kitchen/lattice-grey/01.png',
      '/products/kitchen/lattice-grey/02.png',
      '/products/kitchen/lattice-grey/dim-elevation.svg',
      '/products/kitchen/lattice-grey/dim-carcass.svg',
    ],
    imageCaptions: [
      'Full kitchen run — lattice uppers, tall flanks, base cabinets.',
      'Open wall-cabinet carcass — light oak interior with 2 shelves.',
      'Shop drawing 1 — exterior elevation (W × H × D reference).',
      'Shop drawing 2 — detailed carcass (open bay, shelves, LED, base).',
    ],
    highlights: [
      'Lattice decorative shutters',
      'Light oak carcass interior',
      'Tall flanks + loft + base',
      'Under-cabinet LED',
      'Made to measure',
      'WhatsApp quote available',
    ],
    ...
    specifications: [
      { label: 'Type', value: 'Modular kitchen run' },
      { label: 'Shutter finish', value: 'Light grey PU / laminate · lattice cutouts' },
      { label: 'Carcass', value: 'BWP plywood · light oak laminate both sides · 2 mm edge banding' },
      { label: 'Board Thickness', value: '18 mm (25 mm optional)' },
      { label: 'Hardware', value: 'Handle-less / push-to-open' },
      { label: 'Lighting', value: 'Under-cabinet LED' },
      {
        label: 'Pricing',
        value: 'Per sq ft — shutter only or with carcass (confirm rates on WhatsApp)',
      },
    ...
    features: [
      'Decorative lattice shutters with lit glass-backed cutouts',
      'Open wall-cabinet carcass with two fixed shelves (three storage levels)',
      'Tall flanking units, loft cabinets, and shaker base cabinets',
