  ...
  },
{
  ...
  {
    id: 'sf-11-boulder-marble-console',
    name: 'Boulder Base Marble Console',
    categoryId: 'sculpted-furniture',
    subcategoryId: 'console',
    price: 124999,
    currency: 'INR',
    ...
    sku: 'PBH-SF-11',
    description:
      'Asymmetric river-boulder console with light grey veined marble top — three smooth stone forms as the base. Entry or living statement piece; confirm length on WhatsApp.',
    style: ['organic', 'minimal', 'luxe'],
    rooms: ['hallway', 'living room', 'foyer'],
    image: '/products/sculpted-furniture/sf-11-boulder-marble-console/01.jpg',
    images: ['/products/sculpted-furniture/sf-11-boulder-marble-console/01.jpg'],
    highlights: [
      'Marble slab top',
  ...
  {
    id: 'sf-12-gradient-boulder-console',
    name: 'Gradient Boulder Live Edge Console',
    categoryId: 'sculpted-furniture',
    subcategoryId: 'console',
    price: 134999,
    currency: 'INR',
    ...
    sku: 'PBH-SF-12',
    description:
      'Live-edge wood console on stacked boulder supports — one base finished in a dark-to-sand gradient. Warm organic entry piece; confirm length on WhatsApp.',
    style: ['organic', 'warm', 'sculptural'],
    rooms: ['hallway', 'living room', 'foyer'],
    image: '/products/sculpted-furniture/sf-12-gradient-boulder-console/01.jpg',
    images: ['/products/sculpted-furniture/sf-12-gradient-boulder-console/01.jpg'],
    highlights: [
      'Live-edge wood top',
      'Stacked boulder base',
      'Gradient patina accent',
      'WhatsApp for length',
    ],
  },
  {
    id: 'sf-13-golden-face-glass-table',
    name: 'Golden Face Glass Coffee Table',
    categoryId: 'sculpted-furniture',
    ...
    sku: 'PBH-SF-13',
    description:
      'Serene sculpted face base in warm golden brass patina with an organic wavy glass top — living-room art coffee table. Confirm size on WhatsApp.',
    style: ['sculptural', 'luxe', 'art'],
    rooms: ['living room', 'lounge'],
    image: '/products/sculpted-furniture/sf-13-golden-face-glass-table/01.jpg',
    images: ['/products/sculpted-furniture/sf-13-golden-face-glass-table/01.jpg'],
    highlights: [
      'Golden face sculpture base',
  ...
  {
    id: 'sf-14-stone-face-glass-table',
    name: 'Stone Face Glass Coffee Table',
    categoryId: 'sculpted-furniture',
    subcategoryId: 'coffee-table',
    price: 154999,
    currency: 'INR',
    ...
    sku: 'PBH-SF-14',
    description:
      'Meditative face base in light travertine stone texture with clear organic glass top — soft, gallery-calm centre table. Confirm size on WhatsApp.',
    style: ['sculptural', 'minimal', 'organic'],
    rooms: ['living room', 'lounge'],
    image: '/products/sculpted-furniture/sf-14-stone-face-glass-table/01.jpg',
    images: ['/products/sculpted-furniture/sf-14-stone-face-glass-table/01.jpg'],
    highlights: [
      'Travertine stone face base',
      'Organic wavy glass top',
      'Gallery living centrepiece',
      'WhatsApp for size',
    ],
  },
{
